...
declare function isFocusedElementEditable(): boolean;
declare function isTypedCharValid({ keyCode, metaKey, ctrlKey, altKey }: KeyboardEvent): boolean;
 ...
 * @param options
 */
declare function onStartTyping(callback: (event: KeyboardEvent) => void, options?: OnStartTypingOptions): void;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useBreakpoints<K extends string>(breakpoints: Breakpoints<K>, options?: UseBreakpointsOptions): UseBreakpointReturn<K>;
//#endregion
...
interface UseBroadcastChannelReturn<D, P> extends Supportable {
...
declare function useCached<T, D extends boolean = true>(refValue: Ref<T>, comparator?: (newSourceValue: T, cachedValue: T) => boolean, options?: UseCachedOptions<D>): UseCachedReturn<T, D>;
...
declare function useCloned<T>(source: MaybeRefOrGetter<T>, options?: UseClonedOptions<T>): UseClonedReturn<T>;
//#endregion
 ...
 * @param options
 */
declare function useCssVar(prop: MaybeRefOrGetter<string | null | undefined>, target?: MaybeElementRef, options?: UseCssVarOptions): import("vue").ShallowRef<string | undefined, string | undefined>;
//#endregion
//#region useCurrentElement/index.d.ts
declare function useCurrentElement<T extends MaybeElement = MaybeElement, R extends VueInstance = VueInstance, E extends MaybeElement = MaybeElement extends T ? IsAny<R['$el']> extends false ? R['$el'] : T : T>(rootComponent?: MaybeElementRef<R>): import("@vueuse/shared").ComputedRefWithControl<E>;
//#endregion
...
//#endregion
//#region useElementOverflow/index.d.ts
interface UseElementOverflowOptions extends ConfigurableWindow {
  /**
 ...
 * @param option
 */
declare function useElementOverflow(target: MaybeComputedElementRef, option?: UseElementOverflowOptions): {
 ...
 */
type ResizeObserverCallback$1 = (entries: ReadonlyArray<ResizeObserverEntry>, observer: ResizeObserver) => void;
 ...
 * @param options
 */
declare function useResizeObserver(target: MaybeComputedElementRefOrArray, callback: globalThis.ResizeObserverCallback, options?: UseResizeObserverOptions): UseResizeObserverReturn;
//#endregion
 ...
 * @param options
 */
declare function useIntersectionObserver(target: MaybeComputedElementRefOrArray, callback: IntersectionObserverCallback, options?: UseIntersectionObserverOptions): UseIntersectionObserverReturn;
//#endregion
//#region useElementVisibility/index.d.ts
interface UseElementVisibilityOptions<Controls extends boolean = false> extends ConfigurableWindow, Pick<UseIntersectionObserverOptions, 'rootMargin' | 'threshold'> {
  /**
   * Initial value.
   *
   * @default false
...
type UseElementVisibilityReturn<Controls extends boolean = false> = Controls extends true ? UseElementVisibilityReturnWithControls : ShallowRef<boolean>;
interface UseElementVisibilityReturnWithControls extends UseIntersectionObserverReturn {
 ...
 */
declare function useElementVisibility(element: MaybeComputedElementRef, options?: UseElementVisibilityOptions<false>): UseElementVisibilityReturn<false>;
declare function useElementVisibility(element: MaybeComputedElementRef, options?: UseElementVisibilityOptions<true>): UseElementVisibilityReturn<true>;
//#endregion
 ...
 */
declare function mapGamepadToXbox360Controller(gamepad: Ref<Gamepad | undefined>): import("vue").ComputedRef<{
  buttons: {
    a: GamepadButton;
    b: GamepadButton;
    x: GamepadButton;
...
//#endregion
//#region useLiveAnnouncer/index.d.ts
interface UseLiveAnnouncerOptions extends ConfigurableWindow {
  /**
...
declare function useLiveAnnouncer(options?: UseLiveAnnouncerOptions): UseLiveAnnouncerReturn;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useMounted(): import("vue").ShallowRef<boolean, boolean>;
//#endregion
 ...
 * @param options
 */
declare function useMutationObserver(target: MaybeComputedElementRefOrArray, callback: MutationCallback, options?: UseMutationObserverOptions): UseMutationObserverReturn;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useNow(options?: UseNowOptions<false>): ShallowRef<Date>;
 ...
 * @param object
 */
declare function useObjectUrl(object: MaybeRefOrGetter<Blob | MediaSource | null | undefined>): Readonly<import("vue").ShallowRef<string | undefined, string | undefined>>;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useOnline(options?: ConfigurableWindow): Readonly<import("vue").ShallowRef<boolean>>;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePreferredColorScheme(options?: ConfigurableWindow): import("vue").ComputedRef<ColorSchemeType>;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePreferredContrast(options?: ConfigurableWindow): import("vue").ComputedRef<ContrastType>;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePreferredDark(options?: ConfigurableWindow): import("vue").ComputedRef<boolean>;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePreferredReducedMotion(options?: ConfigurableWindow): import("vue").ComputedRef<ReducedMotionType>;
//#endregion
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePreferredReducedTransparency(options?: ConfigurableWindow): import("vue").ComputedRef<ReducedTransparencyType>;
//#endregion
 ...
 * @param element
 */
declare function useScrollLock(element: MaybeRefOrGetter<HTMLElement | SVGElement | Window | Document | null | undefined>, initialState?: boolean): import("vue").WritableComputedRef<boolean, boolean>;
//#endregion
...
//#endregion
//#region useTemporalNow/index.d.ts
interface UseTemporalNowOptions extends ConfigurableScheduler {
  /**
   * Initial timezone
   *
   * @default 'UTC'
...
interface UseTemporalNowReturn extends Pausable {
  /**
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useTextDirection(options?: UseTextDirectionOptions): import("vue").WritableComputedRef<UseTextDirectionValue, UseTextDirectionValue>;
//#endregion
...
interface UseVirtualListScrollToOptions {
...
interface UseWebMCPOptions<Args, Result> extends ConfigurableDocument {
  /**
...
interface UseWebMCPReturn extends Supportable {
  /**
 ...
 * @see https://github.com/webmachinelearning/webmcp
 */
declare function useWebMCP<Args = Record<string, any>, Result = unknown>(options: UseWebMCPOptions<Args, Result>): UseWebMCPReturn;
//#endregion
