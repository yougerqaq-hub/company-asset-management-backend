			...
			const onScroll = (e) => {
				...
				if (isRTL(props.direction)) switch (getRTLOffsetType()) {
					case RTL_OFFSET_NAG:
						...
						break;
					case RTL_OFFSET_POS_DESC: _scrollLeft = scrollWidth - clientWidth - scrollLeft;
				}
				states.value = {
					..._states,
					isScrolling: true,
