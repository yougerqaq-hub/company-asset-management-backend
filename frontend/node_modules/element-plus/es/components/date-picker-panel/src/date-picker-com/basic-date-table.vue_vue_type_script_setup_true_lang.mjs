...
import { Fragment, createCommentVNode, createElementBlock, createElementVNode, createVNode, defineComponent, normalizeClass, onBeforeUnmount, openBlock, renderList, toDisplayString, unref, withKeys } from "vue";
...
var basic_date_table_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		const props = __props;
		const { WEEKS, rows, tbodyRef, currentCellRef, focus, isCurrent, isWeekActive, isSelectedCell, handlePickDate, handleMouseUp, handleMouseDown, handleMouseMove, handleFocus, handleKeydown } = useBasicDateTable(props, __emit);
...
focus });
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("table", {
				...
				cellpadding: "0",
				role: "grid",
				onClick: _cache[3] || (_cache[3] = (...args) => unref(handlePickDate) && unref(handlePickDate)(...args)),
				onMousemove: _cache[4] || (_cache[4] = (...args) => unref(handleMouseMove) && unref(handleMouseMove)(...args)),
				onMousedown: _cache[5] || (_cache[5] = (...args) => unref(handleMouseDown) && unref(handleMouseDown)(...args)),
				onMouseup: _cache[6] || (_cache[6] = (...args) => unref(handleMouseUp) && unref(handleMouseUp)(...args))
				...
				return openBlock(), createElementBlock("tr", {
					...
					return openBlock(), createElementBlock("td", {
						...
						onKeydown: [_cache[1] || (_cache[1] = withKeys((...args) => unref(handleKeydown) && unref(handleKeydown)(...args), ["enter"])), _cache[2] || (_cache[2] = withKeys((...args) => unref(handleKeydown) && unref(handleKeydown)(...args), ["space"]))]
