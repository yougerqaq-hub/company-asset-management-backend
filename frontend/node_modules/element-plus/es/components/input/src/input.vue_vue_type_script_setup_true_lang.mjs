...
import { Fragment, computed, createBlock, createCommentVNode, createElementBlock, createElementVNode, defineComponent, mergeProps, nextTick, normalizeClass, normalizeStyle, onBeforeUnmount, onMounted, openBlock, ref, renderSlot, resolveDynamicComponent, shallowRef, toDisplayString, toRef, unref, useAttrs, useSlots, watch, withCtx, withModifiers } from "vue";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createElementVNode("div", {
					...
					suffixVisible.value ? (openBlock(), createElementBlock("span", {
						...
						isWordLimitVisible.value ? (openBlock(), createElementBlock("span", {
							...
							role: "status"
						}, [createElementVNode("span", { class: normalizeClass(unref(nsInput).e("count-inner")) }, toDisplayString(textLength.value) + " / " + toDisplayString(maxlength.value), 3)], 10, _hoisted_2)) : createCommentVNode("v-if", true),
				...
				isWordLimitVisible.value ? (openBlock(), createElementBlock("span", {
					...
					"aria-label": wordLimitLabel.value,
					role: "status"
				}, toDisplayString(textLength.value) + " / " + toDisplayString(maxlength.value), 15, _hoisted_4)) : createCommentVNode("v-if", true)
			], 64))], 38);
		};
	}
});
