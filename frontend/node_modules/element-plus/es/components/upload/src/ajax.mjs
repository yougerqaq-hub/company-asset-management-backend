...
const ajaxUpload = (option) => {
	...
	if (option.data) for (const [key, value] of Object.entries(option.data)) if (isArray(value)) {
		if (value.length === 2 && value[0] instanceof Blob && isString(value[1])) formData.append(key, value[0], value[1]);
