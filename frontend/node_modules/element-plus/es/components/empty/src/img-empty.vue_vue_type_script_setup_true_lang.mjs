...
var img_empty_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	name: "ImgEmpty",
	__name: "img-empty",
	setup(__props) {
		...
		const id = useId();
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("svg", _hoisted_1, [createElementVNode("defs", null, [
				createElementVNode("linearGradient", {
					...
					offset: "100%"
				}, null, 8, _hoisted_4)], 8, _hoisted_2),
				createElementVNode("linearGradient", {
					...
					"stop-color": `var(${unref(ns).cssVarBlockName("fill-color-1")})`,
					offset: "0%"
				}, null, 8, _hoisted_6), createElementVNode("stop", {
			...
			]), createElementVNode("g", _hoisted_9, [createElementVNode("g", _hoisted_10, [createElementVNode("g", _hoisted_11, [
				...
				createElementVNode("g", _hoisted_20, [createElementVNode("use", {
					fill: `var(${unref(ns).cssVarBlockName("fill-color-8")})`,
					transform: "translate(8.500000, 18.000000) scale(-1, 1) translate(-8.500000, -18.000000) ",
					"xlink:href": `#path-3-${unref(id)}`
				}, null, 8, _hoisted_21), createElementVNode("polygon", {
...
//#endregion
export { img_empty_vue_vue_type_script_setup_true_lang_default as default };

//# sourceMappingURL=img-empty.vue_vue_type_script_setup_true_lang.mjs.map