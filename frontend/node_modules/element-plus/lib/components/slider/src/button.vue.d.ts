...
declare const __VLS_export: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  readonly tooltipClass: EpPropFinalized<(new (...args: any[]) => string | false | Record<string, any> | ClassValue[]) | (() => ClassValue) | (((new (...args: any[]) => string | false | Record<string, any> | ClassValue[]) | (() => ClassValue)) | null)[], unknown, unknown, undefined, boolean>;
  ...
  readonly tooltipClass: ClassValue;
