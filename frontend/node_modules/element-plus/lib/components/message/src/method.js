...
const normalizePlacement = (normalized) => {
	...
	if (!require_message.messagePlacement.includes(normalized.placement)) {
		require_error.debugWarn("ElMessage", `Invalid placement: ${normalized.placement}. Falling back to 'top'.`);
...
const closeMessage = (instance) => {
	const placement = instance.props.placement || "top";
...
const message = (options = {}, context) => {
	...
	const instances = require_instance.getOrCreatePlacementInstances(normalized.placement || "top");
