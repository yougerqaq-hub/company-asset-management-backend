...
*/
const timeSelectProps = require_runtime.buildProps({
	/**
	...
	*/
	modelValue: { type: require_runtime.definePropType(String) },
	/**
	...
	*/
	minTime: { type: require_runtime.definePropType(String) },
	/**
	* @description maximum time, any time after this time will be disabled
	*/
	maxTime: { type: require_runtime.definePropType(String) },
	/**
