...
const getMonthDays = (date) => {
	...
	return require_utils.rangeArr(days).map((_, index) => index + 1);
};
...
*/
const dateTableProps = require_runtime.buildProps({
	selectedDay: { type: require_runtime.definePropType(Object) },
	range: { type: require_runtime.definePropType(Array) },
	date: {
