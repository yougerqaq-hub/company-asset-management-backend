...
*/
const uploadBaseProps = require_runtime.buildProps({
	/**
	...
	*/
	headers: { type: require_runtime.definePropType(Object) },
	/**
...
* @deprecated Removed after 3.0.0, Use `UploadProps` instead.
*/
const uploadProps = require_runtime.buildProps({
	...uploadBaseProps,
	/**
	...
	*/
	beforeRemove: { type: require_runtime.definePropType(Function) },
	/**
