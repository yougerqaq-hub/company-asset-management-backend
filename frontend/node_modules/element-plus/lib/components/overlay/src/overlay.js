...
const overlayProps = require_runtime.buildProps({
	...
	zIndex: { type: require_runtime.definePropType([String, Number]) }
});
	...
	setup(props, { slots, emit }) {
		...
		return () => {
			return props.mask ? (0, vue.createVNode)("div", {
				...
				onMousedown,
				onMouseup
			}, [(0, vue.renderSlot)(slots, "default")], 14, [
				"onClick",
				"onMouseup",
				"onMousedown"
			]) : (0, vue.h)("div", {
