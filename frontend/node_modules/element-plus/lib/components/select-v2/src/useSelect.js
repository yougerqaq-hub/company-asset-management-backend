...
const useSelect = (props, emit) => {
	...
	*/
	...
	(0, vue.watch)(() => props.modelValue, (val, oldVal) => {
		...
		if (!(0, lodash_unified.isEqual)(val, oldVal) && props.validateEvent) elFormItem?.validate?.("change").catch(_vue_shared.NOOP);
	}, { deep: true });
	...
	(0, _vueuse_core.useResizeObserver)(selectRef, () => require_raf.rAF(handleResize));
