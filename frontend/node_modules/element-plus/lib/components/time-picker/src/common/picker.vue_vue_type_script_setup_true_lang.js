...
var picker_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const displayValue = (0, vue.computed)(() => {
			...
			if (formattedValue) return isDatesPicker.value || isMonthsPicker.value || isYearsPicker.value || isQuartersPicker.value ? formattedValue.join(", ") : formattedValue;
			return "";
		});
		...
		const isQuartersPicker = (0, vue.computed)(() => props.type === "quarters");
		...
		const handleKeydownInput = async (event) => {
			...
			if (code === require_aria.EVENT_CODE.enter || code === require_aria.EVENT_CODE.numpadEnter) {
				if (!pickerVisible.value) pickerVisible.value = true;
					...
					handleChange();
					pickerVisible.value = false;
				} else if (!isValidValue(parseUserInputToDayjs(displayValue.value))) require_error.debugWarn("Picker", `Invalid user input: ${displayValue.value}. Please check the format of the input.`);
				event.preventDefault();
				event.stopPropagation();
				return;
			}
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$4.ElTooltip), (0, vue.mergeProps)({
				...
				default: (0, vue.withCtx)(() => [!isRangeInput.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$5.ElInput), {
					...
					readonly: !_ctx.editable || _ctx.readonly || isDatesPicker.value || isMonthsPicker.value || isYearsPicker.value || isQuartersPicker.value || _ctx.type === "week",
