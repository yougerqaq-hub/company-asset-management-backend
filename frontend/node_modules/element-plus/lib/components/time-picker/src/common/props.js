...
const timePickerDefaultProps = require_runtime.buildProps({
	/**
	...
	*/
	id: { type: require_runtime.definePropType([Array, String]) },
	/**
	* @description same as `name` in native input
	*/
	name: { type: require_runtime.definePropType([Array, String]) },
	/**
...
const timePickerRangeTriggerProps = require_runtime.buildProps({
	id: { type: require_runtime.definePropType(Array) },
	name: { type: require_runtime.definePropType(Array) },
	modelValue: { type: require_runtime.definePropType([Array, String]) },
	startPlaceholder: String,
	endPlaceholder: String,
	disabled: Boolean
});
