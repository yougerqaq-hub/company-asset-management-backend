...
const require_use_tab_nav_touch = require("./composables/use-tab-nav-touch.js");
let _vueuse_core = require("@vueuse/core");
let lodash_unified = require("lodash-unified");
let _element_plus_icons_vue = require("@element-plus/icons-vue");
let vue = require("vue");
//#region ../../packages/components/tabs/src/tab-nav.tsx
const tabNavProps = require_runtime.buildProps({
	panes: {
...
const TabNav = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(props, { expose, emit }) {
		...
		const { isTouchScrolling, handleTouchStart, handleTouchMove, handleTouchEnd } = require_use_tab_nav_touch.useTabNavTouch({
			scrollable,
			navOffset,
			navSize,
			navContainerSize,
