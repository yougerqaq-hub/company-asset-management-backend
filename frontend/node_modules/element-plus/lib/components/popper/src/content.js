...
*/
const popperCoreConfigProps = require_runtime.buildProps({
	boundariesPadding: {
		type: Number,
		default: 0
	},
...
*/
const popperContentProps = require_runtime.buildProps({
	...
	className: { type: require_runtime.definePropType([
		String,
		Array,
		Object,
		Boolean
	...
	referenceEl: { type: require_runtime.definePropType(Object) },
	triggerTargetEl: { type: require_runtime.definePropType(Object) },
