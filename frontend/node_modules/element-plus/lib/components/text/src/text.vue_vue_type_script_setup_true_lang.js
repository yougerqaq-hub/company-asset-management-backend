...
var text_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose }) {
		...
		const { width, height } = (0, _vueuse_core.useElementSize)(textRef);
		const isTruncated = (0, vue.ref)(false);
		let rafId;
		const bindTitle = () => {
			if (rafId) require_raf.cAF(rafId);
			rafId = require_raf.rAF(() => {
				rafId = void 0;
		...
		(0, _vueuse_core.useMutationObserver)(textRef, bindTitle, {
			attributes: true,
