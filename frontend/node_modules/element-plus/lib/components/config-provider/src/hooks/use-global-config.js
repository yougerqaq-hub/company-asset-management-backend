...
function useGlobalComponentSettings(block, sizeFallback) {
	...
	const zIndex = require_index$2.useZIndex((0, vue.computed)(() => {
		const zIndex = config.value?.zIndex;
		return (0, lodash_unified.isNil)(zIndex) || Number.isNaN(zIndex) ? require_index$2.defaultInitialZIndex : zIndex;
	}));
...
const mergeConfig = (a, b) => {
	const keys = [.../* @__PURE__ */ new Set([...require_objects.keysOf(a), ...require_objects.keysOf(b)])];
	const obj = {};
