...
var color_picker_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function clear() {
			...
			if (props.modelValue !== valueOnClear.value && props.validateEvent) formItem?.validate("change").catch(_vue_shared.NOOP);
			resetColor();
			emit("clear");
		}
		...
		function handleKeyDown(event) {
			switch (require_event$1.getEventCode(event)) {
				...
				case require_aria.EVENT_CODE.space:
					...
					show();
					break;
				case require_aria.EVENT_CODE.esc: handleEsc(event);
			}
		}
		function focus() {
