...
var autocomplete_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const passInputProps = (0, vue.computed)(() => {
			...
			const keys = (0, _vue_shared.isArray)(inputProps) ? inputProps : Object.keys(inputProps);
			return (0, lodash_unified.pick)(props, keys);
		});
		...
		const debounce = (0, vue.computed)(() => props.debounce);
		const debouncedGetData = (0, _vueuse_core.useDebounceFn)(getData, debounce);
