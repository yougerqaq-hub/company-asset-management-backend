...
const require_index$3 = require("../../../hooks/use-cursor/index.js");
const require_index$4 = require("../../../hooks/use-focus-controller/index.js");
const require_index$5 = require("../../../hooks/use-composition/index.js");
...
var input_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const nsTextarea = require_index$2.useNamespace("textarea");
		...
		const clearIconStyle = (0, vue.ref)();
		...
		const { wrapperRef, isFocused, handleFocus, handleBlur } = require_index$4.useFocusController(_ref, {
			...
			beforeBlur(event) {
				if (props.showPassword) {
					...
					if (!(0, lodash_unified.isNil)(value) && !(0, lodash_unified.isNil)(passwordFocusValue) && value !== passwordFocusValue) target?.dispatchEvent(new Event("change", { bubbles: true }));
					passwordFocusValue = void 0;
				}
			},
			afterBlur() {
				if (props.validateEvent) elFormItem?.validate?.("blur").catch(_vue_shared.NOOP);
			}
		});
		...
		const showClear = (0, vue.computed)(() => renderClear.value && !!nativeInputValue.value && (isFocused.value || hovering.value));
		...
		const wordLimitLabel = (0, vue.computed)(() => t("el.input.characters", {
			count: textLength.value,
			max: maxlength.value ?? ""
		}));
		const inputExceed = (0, vue.computed)(() => !!isWordLimitVisible.value && textLength.value > Number(maxlength.value));
		const suffixVisible = (0, vue.computed)(() => !!slots.suffix || !!props.suffixIcon || props.clearable || props.showPassword || isWordLimitVisible.value || !!validateState.value && needStatusIcon.value);
		const hasModelModifiers = (0, vue.computed)(() => !!Object.keys(props.modelModifiers).length);
		const [recordCursor, setCursor] = require_index$3.useCursor(input);
		let rAFId;
...
right: `calc(100% - ${width - 11}px)` };
			...
			rAFId && require_raf.cAF(rAFId);
			rAFId = require_raf.rAF(updateStyle);
		});
		...
		const { isComposing, handleCompositionStart, handleCompositionUpdate, handleCompositionEnd } = require_index$5.useComposition({
			emit,
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
				...
				(0, vue.createElementVNode)("div", {
					...
					}, [(0, vue.createElementVNode)("span", { class: (0, vue.normalizeClass)((0, vue.unref)(nsInput).e("prefix-inner")) }, [(0, vue.renderSlot)(_ctx.$slots, "prefix"), __props.prefixIcon ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$6.ElIcon), {
						key: 0,
					...
					suffixVisible.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
						...
						renderClear.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$6.ElIcon), {
							key: 0,
							class: (0, vue.normalizeClass)([(0, vue.unref)(nsInput).e("icon"), (0, vue.unref)(nsInput).e("clear")]),
							style: (0, vue.normalizeStyle)({ visibility: showClear.value ? "visible" : "hidden" }),
						...
						!showClear.value || !showPwdVisible.value || !isWordLimitVisible.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: 1 }, [(0, vue.renderSlot)(_ctx.$slots, "suffix"), __props.suffixIcon ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$6.ElIcon), {
							key: 0,
							class: (0, vue.normalizeClass)((0, vue.unref)(nsInput).e("icon"))
						}, {
						...
						showPwdVisible.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$6.ElIcon), {
							key: 2,
						...
						isWordLimitVisible.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
							...
							role: "status"
						}, [(0, vue.createElementVNode)("span", { class: (0, vue.normalizeClass)((0, vue.unref)(nsInput).e("count-inner")) }, (0, vue.toDisplayString)(textLength.value) + " / " + (0, vue.toDisplayString)(maxlength.value), 3)], 10, _hoisted_2)) : (0, vue.createCommentVNode)("v-if", true),
						validateState.value && validateIcon.value && needStatusIcon.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$6.ElIcon), {
							key: 4,
				...
				showClear.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_index$6.ElIcon), {
					key: 0,
					class: (0, vue.normalizeClass)([(0, vue.unref)(nsTextarea).e("icon"), (0, vue.unref)(nsTextarea).e("clear")]),
					style: (0, vue.normalizeStyle)(clearIconStyle.value),
					onMousedown: (0, vue.withModifiers)((0, vue.unref)(_vue_shared.NOOP), ["prevent"]),
					onClick: clear
				}, {
					default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)(__props.clearIcon)))]),
				...
				isWordLimitVisible.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
					...
					"aria-label": wordLimitLabel.value,
					role: "status"
				}, (0, vue.toDisplayString)(textLength.value) + " / " + (0, vue.toDisplayString)(maxlength.value), 15, _hoisted_4)) : (0, vue.createCommentVNode)("v-if", true)
			], 64))], 38);
		};
	}
});
