...
*/
const mentionProps = require_runtime.buildProps({
	...
	*/
	filterOption: {
		type: require_runtime.definePropType([Boolean, Function]),
	...
	*/
	checkIsWhole: { type: require_runtime.definePropType(Function) },
	/**
