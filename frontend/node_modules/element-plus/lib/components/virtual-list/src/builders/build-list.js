...
const createList = ({ name, getOffset, getItemSize, getItemOffset, getEstimatedTotalSize, getStartIndexForOffset, getStopIndexForStartIndex, initCache, clearCache, validateProps }) => {
	return (0, vue.defineComponent)({
		...
		setup(props, { emit, expose }) {
			...
			const startEdgeReached = (0, vue.computed)(() => currentEdgeState.value.start);
			const endEdgeReached = (0, vue.computed)(() => currentEdgeState.value.end);
			...
			const scrollHorizontally = (e) => {
				...
				if (direction === "rtl") switch (require_utils.getRTLOffsetType()) {
					case require_defaults.RTL_OFFSET_NAG:
						...
						break;
					case require_defaults.RTL_OFFSET_POS_DESC: scrollOffset = scrollWidth - clientWidth - scrollLeft;
				}
			...
			(0, vue.onMounted)(() => {
				...
				if (require_types.isNumber(initScrollOffset) && windowElement) {
					if ((0, vue.unref)(_isHorizontal)) windowElement.scrollLeft = initScrollOffset;
