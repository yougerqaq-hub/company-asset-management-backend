...
let dayjs_plugin_quarterOfYear_js = require("dayjs/plugin/quarterOfYear.js");
dayjs_plugin_quarterOfYear_js = require_runtime.__toESM(dayjs_plugin_quarterOfYear_js);
...
dayjs.default.extend(dayjs_plugin_quarterOfYear_js.default);
...
var date_picker_panel_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		...
		const pickerInjection = (0, vue.inject)(require_constants.PICKER_BASE_INJECTION_KEY, void 0);
		if (require_types.isUndefined(pickerInjection)) {
			const _props = (0, vue.reactive)({ ...(0, vue.toRefs)(props) });
			(0, vue.provide)(require_constants.PICKER_BASE_INJECTION_KEY, { props: _props });
		}
		...
		return () => {
			const Component = require_panel_utils.getPanel(props.type);
			return (0, vue.createVNode)(Component, (0, vue.mergeProps)((0, lodash_unified.omit)(attrs, "onPick"), props, {
