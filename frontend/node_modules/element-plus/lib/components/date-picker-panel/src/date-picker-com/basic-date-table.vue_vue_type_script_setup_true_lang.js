...
var basic_date_table_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		const props = __props;
		const { WEEKS, rows, tbodyRef, currentCellRef, focus, isCurrent, isWeekActive, isSelectedCell, handlePickDate, handleMouseUp, handleMouseDown, handleMouseMove, handleFocus, handleKeydown } = require_use_basic_date_table.useBasicDateTable(props, __emit);
...
focus });
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("table", {
				...
				cellpadding: "0",
				role: "grid",
				onClick: _cache[3] || (_cache[3] = (...args) => (0, vue.unref)(handlePickDate) && (0, vue.unref)(handlePickDate)(...args)),
				onMousemove: _cache[4] || (_cache[4] = (...args) => (0, vue.unref)(handleMouseMove) && (0, vue.unref)(handleMouseMove)(...args)),
				onMousedown: _cache[5] || (_cache[5] = (...args) => (0, vue.unref)(handleMouseDown) && (0, vue.unref)(handleMouseDown)(...args)),
				onMouseup: _cache[6] || (_cache[6] = (...args) => (0, vue.unref)(handleMouseUp) && (0, vue.unref)(handleMouseUp)(...args))
				...
				return (0, vue.openBlock)(), (0, vue.createElementBlock)("tr", {
					...
					return (0, vue.openBlock)(), (0, vue.createElementBlock)("td", {
						...
						onKeydown: [_cache[1] || (_cache[1] = (0, vue.withKeys)((...args) => (0, vue.unref)(handleKeydown) && (0, vue.unref)(handleKeydown)(...args), ["enter"])), _cache[2] || (_cache[2] = (0, vue.withKeys)((...args) => (0, vue.unref)(handleKeydown) && (0, vue.unref)(handleKeydown)(...args), ["space"]))]
