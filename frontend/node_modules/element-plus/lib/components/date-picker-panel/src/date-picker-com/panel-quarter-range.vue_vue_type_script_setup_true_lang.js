...
const require_panel_quarter_range = require("../props/panel-quarter-range.js");
...
const unit = "year";
var panel_quarter_range_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue.defineComponent)({
	name: "DatePickerQuarterRange",
	__name: "panel-quarter-range",
	props: require_panel_quarter_range.panelQuarterRangeProps,
	emits: require_panel_quarter_range.panelQuarterRangeEmits,
	setup(__props, { emit: __emit }) {
		...
		const normalizeQuarterInput = (value) => require_utils.normalizeQuarterDate(value, lang.value, disabledDate.value);
		const parseUserInput = (value) => {
			const parsed = require_utils.correctlyParseUserInput(value, format.value, lang.value);
			if ((0, _vue_shared.isArray)(parsed)) return parsed.map((item) => normalizeQuarterInput(item));
			return normalizeQuarterInput(parsed);
		};
		const isValidValue = (date) => {
			return require_utils.isValidRange(date) && (disabledDate.value ? !disabledDate.value(date[0].toDate()) && !disabledDate.value(date[1].toDate()) : true) && !require_utils.isQuarterFullyDisabled(date[0], lang.value, disabledDate.value) && !require_utils.isQuarterFullyDisabled(date[1], lang.value, disabledDate.value);
		};
		function sortDates(minDate, maxDate) {
			if (props.unlinkPanels && maxDate) {
				const minDateYear = minDate?.year() || 0;
				const maxDateYear = maxDate.year();
				rightDate.value = minDateYear === maxDateYear ? maxDate.add(1, unit) : maxDate;
			} else rightDate.value = leftDate.value.add(1, unit);
		}
		const quarterRangeDisabled = require_use_form_common_props.useFormDisabled();
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", { class: (0, vue.normalizeClass)([
				...
				(0, vue.unref)(ppNs).is("disabled", (0, vue.unref)(quarterRangeDisabled)),
				{
				...
				hasShortcuts.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
					...
					return (0, vue.openBlock)(), (0, vue.createElementBlock)("button", {
						...
						disabled: (0, vue.unref)(quarterRangeDisabled),
				...
				(0, vue.createElementVNode)("div", { class: (0, vue.normalizeClass)((0, vue.unref)(ppNs).e("body")) }, [(0, vue.createElementVNode)("div", { class: (0, vue.normalizeClass)([
					...
					_ctx.unlinkPanels || _ctx.singlePanel ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("button", {
						key: 0,
						type: "button",
						disabled: !enableYearArrow.value || (0, vue.unref)(quarterRangeDisabled),
						class: (0, vue.normalizeClass)([[(0, vue.unref)(ppNs).e("icon-btn"), (0, vue.unref)(ppNs).is("disabled", !enableYearArrow.value || (0, vue.unref)(quarterRangeDisabled))], "d-arrow-right"]),
				...
				], 2), (0, vue.createVNode)(require_basic_quarter_table.default, {
					...
					_ctx.unlinkPanels ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("button", {
						...
						type: "button",
						disabled: !enableYearArrow.value || (0, vue.unref)(quarterRangeDisabled),
						class: (0, vue.normalizeClass)([[(0, vue.unref)(ppNs).e("icon-btn"), (0, vue.unref)(ppNs).is("disabled", !enableYearArrow.value || (0, vue.unref)(quarterRangeDisabled))], "d-arrow-left"]),
...
//#endregion
exports.default = panel_quarter_range_vue_vue_type_script_setup_true_lang_default;

//# sourceMappingURL=panel-quarter-range.vue_vue_type_script_setup_true_lang.js.map