...
const usePanelDateRange = (props, emit, leftDate, rightDate) => {
	...
	async function handlePick(mode, pickerType, value) {
		...
		if (mode === "year") {
			...
			startDate.value = require_utils.getValidDateOfYear(data, lang.value, disabledDate.value);
		}
		if (mode === "month") startDate.value = require_utils.getValidDateOfMonth(startDate.value, startDate.value.year(), value, lang.value, disabledDate.value);
