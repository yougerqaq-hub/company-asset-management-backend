...
const OnlyChild = /* @__PURE__ */ (0, vue.defineComponent)({
	name: NAME,
	setup(_, { slots, attrs }) {
		const forwardRefInjection = (0, vue.inject)(require_index$1.FORWARD_REF_INJECTION_KEY);
		const forwardRefDirective = require_index$1.useForwardRefDirective(forwardRefInjection?.setForwardRef ?? _vue_shared.NOOP);
		return () => {
