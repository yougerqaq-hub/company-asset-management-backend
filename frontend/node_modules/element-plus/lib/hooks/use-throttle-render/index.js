...
const useThrottleRender = (loading, throttle = 0) => {
	...
	const initVal = (0, _vue_shared.isObject)(throttle) && Boolean(throttle.initVal);
	const throttled = (0, vue.ref)(initVal);
	...
	const dispatcher = (type) => {
		if (type === "leading") {
			if (require_types.isNumber(throttle)) dispatchThrottling(throttle);
